                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Jumlah Mahasiswa</p>
                                        <span class="title text-black font-w600">{{ $admin }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="media align-items-center">
                                    <span class="activity-icon bgl-secondary  mr-md-4 mr-3">
                                        <svg width="40" height="37" viewBox="0 0 40 37" fill="none"
                                            ...
                                            margin-right: 0px;
                                            margin-left: 2px;
                                            color: purple;" class="fas fa-user-tie"></i>
                                        </svg>
                                    </span>
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Jumlah Dosen</p>
                                        <span class="title text-black font-w600">{{ $dosen }}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                                ...
                                <div class="media align-items-center">
                                    <span class="activity-icon bgl-danger mr-md-4 mr-3">
                                        <svg width="40" height="39" viewBox="0 0 40 39" fill="none"
                                            ...
                                            margin-right: 0px;
                                            margin-left: 2px;
                                            color: red;" class="fas fa-book-open"></i>
                                        </svg>
                                    </span>
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Jumlah Matkul</p>
                                        <span class="title text-black font-w600">{{$matkul}}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                                ...
                                <div class="media align-items-center">
                                    <span class="activity-icon bgl-warning  mr-md-4 mr-3">
                                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                            ...
                                            margin-right: 0px;
                                            margin-left: 2px;
                                            color: orange;" class="fas fa-user-friends"></i>
                                        </svg>
                                    </span>
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Jumlah jurusan</p>
                                        <span class="title text-black font-w600">{{ $jurusan }}</span>

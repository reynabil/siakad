...
<!-- Mirrored from gymove.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Nov 2022 01:35:29 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('template/nabil/xhtml/images/siakad.png')}}">
	<link rel="stylesheet" href="{{ asset('template/nabil/xhtml/vendor/chartist/css/chartist.min.css') }}">
    <link href="{{ asset('template/nabil/xhtml/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('template/nabil/xhtml/images/.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('template/nabil/xhtml/images/logo-text.png') }}" alt="">
                <img class="brand-title" src="{{ asset('template/nabil/xhtml/images/esiakad.png') }}" alt="">
            </a>
...
<!-- Mirrored from gymove.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Nov 2022 01:36:22 GMT -->
</html>

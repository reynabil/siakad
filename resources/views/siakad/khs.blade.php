...
<body>
    <h1 class="text-center mb-4">DATA KHS</h1>

    <div class="container">
        <a href="/tambahdatakhs" class="btn btn-success mb-5">Tambah Data</a>
        <div class="row">
                ...
                <tbody>
                    ...
                    @foreach ($data as $row)
                        <tr>
                            ...
                            <td>{{ $row->nilai}}</td>
                            <td>
                                <a href="/tampildatakhs/{{ $row->id }}" class="btn btn-warning"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>
...
<script>
    $('.delete').click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deletekhs/" + mahasiswaid + ""

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <a href="/tambahdataadmin" class="btn btn-success mb-5">Tambah Data</a>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->alamat }}</td>
                                            <td>
                                                <a href="/tampildataadmin/{{ $row->id }}" class="btn btn-warning"><i
                                                        class="fa-sharp fa-solid fa-pen-to-square"></i></a>
                                                <a href="#" class="btn btn-danger delete"
                                                    data-id="{{ $row->id }}"
                                                    data-nama_mahasiswa="{{ $row->nama_mahasiswa }}"><i
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deleteadmin/" + mahasiswaid + ""

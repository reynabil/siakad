...
@section('content')
    ...
    <body>
        <h1 class="text-center mb-4">DATA RUANG</h1>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <a href="/tambahdataruang" class="btn btn-success mb-5">Tambah Data</a>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/tampildataruang/{{ $row->id }}" class="btn btn-warning"><i
                                                        class="fa-sharp fa-solid fa-pen-to-square"></i></a>
                                                <a href="#" class="btn btn-danger delete"
                                                    data-id="{{ $row->id }}"
                                                    data-kode_ruang="{{ $row->kode_ruang }}"><i
    ...
    <script>
        $('.delete').click(function() {
            ...
            var nama = $(this).attr('data-kode_ruang');
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                    ...
                    text: "Kamu Akan Menghapus Data Ruang " + nama + " ",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deleteruang/" + mahasiswaid + ""

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <a href="/tambahdatajadwaldosen" class="btn btn-success mb-5">Tambah Data</a>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->dosens->nama_dosen  }}</td>
                                            <td>{{ $row->nip  }}</td>
                                            <td>{{ $row->ruangs->kode_ruang }}</td>
                                            <td>{{ $row->waktu }}</td>
                                            <td>
                                                <a href="/tampildatajadwaldosen/{{ $row->id }}" class="btn btn-warning"><i
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                    ...
                    text: "Kamu Akan Menghapus Data Tersebut " + nama + " ",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })

...
@section('content')
    ...
    <body>
        <h1 class="text-center mb-4">Tambah Data Krs</h1>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/insertdatakrs" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 mt-3">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="number" readonly class="form-control" name="id_jurusan" id=id_jurusan"
                                        aria-describedby="emailHelp">
                                </div>
                                @error('id_jurusan')
                                    <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="number" readonly class="form-control" name="kode_jurusan" id="kodej"
                                        aria-describedby="emailHelp">
                                </div>
                                @error('kode_jurusan')
                                    <div class="text-danger">{{ $message }}</div>
        ...
        <script>
            ...
            jurusan.onchange = function(e) {
                const kodej = e.target.options[e.target.selectedIndex].dataset.kodej
                document.getElementById('kodej').value = kodej;
            }
        </script>

        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/updatedatamatkul/{{ $data->id }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 mt-3">
                                    <label for="kode_matkul" class="form-label">Kode Matkul</label>
                                    <input type="number" class="form-control" name="kode_matkul" id="kode_matkul"
                                ...
                                <div class="mb-3 mt-3">
                                    <label for="nama" class="form-label">MATKUL</label>
                                    <input type="text" class="form-control" name="matkul" id="matkul"
                                        aria-describedby="emailHelp" value="{{$data->matkul}}">
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <select class="form-select" name="sks" aria-label="Default select example">
                                        <option value="{{$data->sks}}"selected>{{ $data->sks }}</option>

...
@section('content')
    ...
    <body>
        <h1 class="text-center mb-4">DATA JURUSAN</h1>

        <div class="container">
            <a href="/tambahdatajurusan" class="btn btn-success mb-5">Tambah Data</a>
            <div class="row">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td>{{ $row->jurusan }}</td>
                                <td>
                                    <a href="/tampildatajurusan/{{ $row->id }}" class="btn btn-warning"><i
                                            class="fa-sharp fa-solid fa-pen-to-square"></i></a>
                                    <a href="#" class="btn btn-danger delete" data-id="{{ $row->id }}"
                                        data-jurusan="{{ $row->jurusan }}"><i class="fa-sharp fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    <script>
        $('.delete').click(function() {
            var mahasiswaid = $(this).attr('data-id');
            var nama = $(this).attr('data-jurusan');
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletejurusan/" + mahasiswaid + ""

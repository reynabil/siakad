        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/updatedatadosen/{{ $data->id }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 mt-3">
                                    <label for="nidn" class="form-label">NIP</label>
                                    <input type="number" readonly class="form-control " name="nip" id="nim"
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_dosen" id="nama_dosen"
                                        aria-describedby="emailHelp" value="{{ $data->nama_dosen }}">
                                </div>
                                @error('nama_dosen')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <img class="img mb-3" src="{{ asset('fotodosen/' . $data->foto) }}" alt=""
                                        style="width: 90px;">

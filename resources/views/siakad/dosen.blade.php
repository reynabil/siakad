...
@section('content')
    ...
    <body>
        ...
        <div class="container">
            <a href="/tambahdatadosen" class="btn btn-success mb-5">Tambah Data</a>
            <div class="row">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="/tampildatadosen/{{ $row->id }}" class="btn btn-warning"><i
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletedosen/" + mahasiswaid + ""

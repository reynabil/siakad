...
@section('content')
    ...
    <body>
        <h1 class="text-center mb-4">Tambah Data Jadwal Mahasiswa</h1>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/submitdata1" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 mt-3">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                    <select class="form-select" name="dosens_id" aria-label="Default select example">
                                        <option value=""></option>
